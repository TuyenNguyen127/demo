...
import 'bloc/send_box_address_bloc.dart';
...
class SendBoxAddressScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SendBoxAddressBloc>(
        create: (context) => SendBoxAddressBloc(
            SendBoxAddressState(sendBoxAddressModelObj: SendBoxAddressModel()))
          ..add(SendBoxAddressInitialEvent()),
        child: SendBoxAddressScreen());
  }
  ...
  Widget _buildPhoneNumber(BuildContext context) {
    return BlocSelector<SendBoxAddressBloc, SendBoxAddressState,
    ...
    return GestureDetector(
        ...
        child: Container(
            ...
            child: Row(
                ...
                children: [
                  BlocSelector<SendBoxAddressBloc, SendBoxAddressState,
                          String?>(
                      selector: (state) => state.sendBoxAddressModelObj!.date,
  ...
  Widget _buildCity(BuildContext context) {
    return Expanded(
        child: Padding(
            ...
            child: BlocSelector<SendBoxAddressBloc, SendBoxAddressState,
                    TextEditingController?>(
  ...
  /// current [sendBoxAddressModelObj] object if the user selects a valid date.
  ///
  /// This function returns a `Future` that completes with `void`.
  Future<void> onTapTime(BuildContext context) async {
    var initialState = BlocProvider.of<SendBoxAddressBloc>(context).state;
    ...
    if (dateTime != null) {
      initialState.sendBoxAddressModelObj?.selectedDate = dateTime;
      context.read<SendBoxAddressBloc>().add(ChangeDateEvent(
